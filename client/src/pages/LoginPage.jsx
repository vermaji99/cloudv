...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-brand-950">
            <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gradient-to-br from-brand-900 via-brand-800 to-brand-950 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 xl:px-24 text-white">
                    <div className="mb-8">
                        <div className="flex items-center space-x-3 mb-6">
                            <div className="p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                <Cloud className="w-10 h-10 text-accent-400" />
                            </div>
                        ...
                        <h1 className="text-4xl xl:text-5xl font-extrabold leading-tight mb-4 text-white">
                            ...
                            <span className="text-accent-400">Like a Pro</span>
                        </h1>
                    ...
                    <div className="space-y-4">
                        {[
                            { icon: ShieldCheck, title: 'Secure OAuth 2.0', desc: 'Enterprise-grade security with Salesforce' },
                            { icon: Zap, title: 'Instant Updates', desc: 'Real-time metadata management' },
                            { icon: CheckCircle, title: 'Bulk Operations', desc: 'Enable or disable rules in batch' },
                        ].map((feature, i) => (
                            <div key={i} className="flex items-center space-x-4 p-4 bg-white/5 backdrop-blur-md rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
                                <feature.icon className="w-6 h-6 text-accent-400 flex-shrink-0" />
                                <div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12">
                <div className="w-full max-w-md">
                    <div className="lg:hidden text-center mb-8">
                        <div className="inline-flex items-center justify-center w-16 h-16 bg-brand-900 rounded-2xl mb-4 shadow-xl border border-brand-800">
                            <Cloud className="w-8 h-8 text-accent-400" />
                        </div>
                        <h1 className="text-2xl font-bold text-white">CloudV Metadata</h1>
                    </div>

                    <div className="bg-white rounded-3xl shadow-elevated p-8 sm:p-10 border border-brand-100">
                        ...
                        <button
                            onClick={login}
                            className="w-full group flex items-center justify-center space-x-3 px-4 sm:px-6 py-4 bg-accent-600 text-white font-bold rounded-2xl shadow-lg shadow-accent-600/30 hover:shadow-xl hover:shadow-accent-700/40 hover:bg-accent-700 active:scale-[0.98] transition-all duration-200"
                        >
